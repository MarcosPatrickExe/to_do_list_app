...
// aqui nesse arquivo 'main' podera ser criado futuramente um BlocProvider
...
class MyApp extends StatelessWidget {
         ...
         // o metodo abaixo eh chamado pelo framework em tempo de execucao, pois eh sobrescrito
          @override
